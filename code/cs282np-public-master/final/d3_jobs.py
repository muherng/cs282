...
for filename in files:
	...
	for par in param:
            for he in held:
                ...
                fo.write("#SBATCH -o df" + name + str(par) + str(he) + "_%a.out\n")
                fo.write("#SBATCH -e df" + name +str(par)+ str(he) + "_%a.err\n")
                fo.write("#SBATCH -N 1\n")
                fo.write("#SBATCH -n 1\n")
                ...
                fo.write("python -W ignore d3_tests.py " + filename + " " + str(par) + " " + str(he) + "\n")
                fo.close()
